// app/(founder)/founders/[founderId]/page.tsx

import FounderDetailClient from "./FounderDetailClient";

export async function generateStaticParams() {
  // Hardcode known founder IDs or import from a local file
  const founderIds = ["1", "2", "3"]; // Replace with actual IDs

  return founderIds.map((id) => ({
    founderId: id,
  }));
}
...
export default async function Page({
  ...
  return <FounderDetailClient params={params} />;
}

// export default function Page({ params, }: Promise<{ founderId: string }) {
//   return <FounderDetailClient params={params} />;
// }
